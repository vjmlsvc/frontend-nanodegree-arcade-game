/* Resources.js
 * This is simply an image loading utility. It eases the process of
...
(function() {
    ...
    function _load(url) {
        if(resourceCache[url]) {
            ...
            /* This URL has not been previously loaded and is not
             * present within our cache; we'll need to load this image.
             */
            var img = new Image();
            img.onload = function() {
                /* Once our image has properly loaded, add it to our
                 * cache so that we can simply return this image if the
                 * developer attempts to load this file in the future.
                 */
                resourceCache[url] = img;

                /* Once the image is actually loaded and properly
                 * cached, call all of the onReady() callbacks we have
                 * defined.
                 */
                if(isReady()) {
             ...
             * Finally, point the image's src attribute to the passed
             * in URL.
             */
    ...
    /* This function will add a function to the callback stack that is
     ...
     * to developers by creating a global Resources object.
     */
    window.Resources = {
        load: load,
        get: get,
